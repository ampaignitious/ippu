...
class _OurCoreValuesState extends State<OurCoreValues> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        title: Text("Our Core Values", style: GoogleFonts.lato(),),
      ),
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text("${coreValueOpeningSentence}", style: GoogleFonts.lato(
            ...
            Padding(
              padding: EdgeInsets.symmetric(horizontal: size.width*0.022),
              child: Center(
                child: Text("${coreValueSubtitle}", style: GoogleFonts.lato(
                  fontSize: size.height* 0.018,
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Text("Transparency", style: GoogleFonts.lato(
                      color: Color.fromARGB(210, 14, 55, 88),
            ...
            spreadRadius: 0.2, // Adjust the spread radius
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left:size.width*0.022),
                    child: Text("Honesty", style: GoogleFonts.lato(
                      color: Color.fromARGB(210, 14, 55, 88),
                      fontSize: size.height* 0.022,
                    ),),
                  ),
            ...
            spreadRadius: 0.2, // Adjust the spread radius
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left:size.width*0.022),
                    child: Text("Integrity", style: GoogleFonts.lato(
                      color: Color.fromARGB(210, 14, 55, 88),
                      fontSize: size.height* 0.022,
                    ),),
                  ),
            ...
            spreadRadius: 0.2, // Adjust the spread radius
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left:size.width*0.022),
                    child: Text("Fairness", style: GoogleFonts.lato(
                      color: Color.fromARGB(210, 14, 55, 88),
                      fontSize: size.height* 0.022,
                    ),),
                  ),
            ...
            spreadRadius: 0.2, // Adjust the spread radius
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left:size.width*0.022),
                    child: Text("Ethics", style: GoogleFonts.lato(
                      color: Color.fromARGB(210, 14, 55, 88),
                      fontSize: size.height* 0.022,
                    ),),
                  ),
            ...
            spreadRadius: 0.2, // Adjust the spread radius
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left:size.width*0.022),
                    child: Text("Professionalism", style: GoogleFonts.lato(
                      color: Color.fromARGB(210, 14, 55, 88),
                      fontSize: size.height* 0.022,
                    ),),
                  ),
            ...
            spreadRadius: 0.2, // Adjust the spread radius
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding: EdgeInsets.only(left:size.width*0.022),
                    child: Text("Team Work", style: GoogleFonts.lato(
                      color: Color.fromARGB(210, 14, 55, 88),
                      fontSize: size.height* 0.022,
                    ),),
                  ),
                  ...
                  Padding(
                    padding: EdgeInsets.symmetric(horizontal:size.width*0.022),
                    child: Text("${teamwork}", style: GoogleFonts.lato(
                      color: Colors.black,
                      fontSize: size.height* 0.020,
                    ), textAlign: TextAlign.justify,),
                  )
