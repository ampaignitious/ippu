        ...
        children: [
          ...
          Expanded(
            child: FutureBuilder<List<dynamic>>(
              future: authController.getUpcomingEvents(),
                  ...
                  if (data != null) {
                    return ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        final eventName = events['name'];
                        final startDate = events['start_date'];
                        final endDate = events['end_date'];
                        final description = events['details'];
                                ...
                                border: Border.all(
                                  color: Colors.grey.withOpacity(0.5)
                                   ...
                                   image: DecorationImage(
                                    image: NetworkImage(
                                        'http://app.ippu.or.ug/storage/banners/$imageLink'),
                                  ),
                                ),
                              ),
                    ...
                    return Container(); // Return an empty container for non-matching eventss
                  }
                }
              },
            ),
