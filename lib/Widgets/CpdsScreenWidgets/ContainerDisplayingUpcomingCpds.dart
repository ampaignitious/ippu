                    ...
                    Row(
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text("${activityname[index]}", style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold, fontSize: size.height*0.018),),
                        ),
                        Padding(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Text("Free", style: TextStyle(fontSize: size.height*0.008, color: Colors.white),)
                        ],
                      ),
