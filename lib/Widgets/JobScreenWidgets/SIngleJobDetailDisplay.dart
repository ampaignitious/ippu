...
class SingleJobDetailDisplayScreen extends StatefulWidget {
  ...
  String deadline;
  String description;
   SingleJobDetailDisplayScreen({super.key, required this.title, required this.deadline, required this.description});

  @override
  State<SingleJobDetailDisplayScreen> createState() => _SingleJobDetailDisplayScreenState(this.deadline, this.description, this.title );
}

class _SingleJobDetailDisplayScreenState extends State<SingleJobDetailDisplayScreen> {
  @override
  String title;
  String deadline;
  String description;
  _SingleJobDetailDisplayScreenState(this.deadline, this.description, this.title );
