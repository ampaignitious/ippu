...
class _StatDisplayRowState extends State<StatDisplayRow> {
  ...
  final totalCommunication = Provider.of<UserProvider>(context).totalCommunications;
    return Row(
                    ...
                    Center(child: Text("$totalEvents", style: TextStyle(fontSize: size.height*0.0342, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 50, 155, 132), letterSpacing: 1),))
                      ],
                    ),
                    ),
                    // attend CPD
